...
class SharedPrefsClient implements LocalStorageClient {
...
final sharedPreferenceClientProvider = Provider((ref) {
  final SharedPrefsClient prefsClient = SharedPrefsClient();
  prefsClient.init();
  return prefsClient;
});
